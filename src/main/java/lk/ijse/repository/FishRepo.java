...
public class FishRepo {
        ...
        public static boolean save(FishDTO fish) throws SQLException {
        ...
        public static boolean update(FishDTO fish) throws SQLException {
        ...
        public static FishDTO searchById(String id) throws SQLException {
            ...
            if (resultSet.next()) {
                ...
                FishDTO fish = new FishDTO(fishId, name, qty, normalPrice, WholeSalePrice);
        ...
        public static List<FishDTO> getAll() throws SQLException {
