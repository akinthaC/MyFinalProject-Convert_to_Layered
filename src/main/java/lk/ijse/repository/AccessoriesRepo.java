...
public class AccessoriesRepo {
    public static boolean save(AccessoriesDTO accessories) throws SQLException {
    ...
    public static boolean update(AccessoriesDTO accessories) throws SQLException {
    ...
    public static List<AccessoriesDTO> getAll() throws SQLException {
    ...
    public static AccessoriesDTO searchById(String id) throws SQLException {
