...
public class SupAccRepo {
    public static List<SupAccDTO> getAll() throws SQLException {
        ...
        List<SupAccDTO> accList = new ArrayList<>();
    ...
    public static boolean save(SupAccDTO supAcc) throws SQLException {
