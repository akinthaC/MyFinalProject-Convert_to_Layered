...
public class SupplierRepo {
    ...
    public static SupplierDTO searchByNIC(String nic) throws SQLException {
        ...
        if (resultSet.next()) {
            ...
            SupplierDTO supplier =new SupplierDTO(supId, SupName,Contact,Nic,address);
    ...
    public static SupplierDTO searchById(String id) throws SQLException {
        ...
        if (resultSet.next()) {
            ...
            SupplierDTO supplier= new SupplierDTO(supid,name,contact,NIC,address);
